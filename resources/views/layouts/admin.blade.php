...
<body id="page-top">
    ...
    <div id="wrapper">
        <!-- Sidebar -->
        <ul style="background-color: #3700b3" class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">SPKWP</div>
            </a>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <figure style="background-color: #3700b3" class="img-profile rounded-circle avatar font-weight-bold"
